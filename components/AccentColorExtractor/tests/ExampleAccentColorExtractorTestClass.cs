...
namespace AccentColorExtractorExperiment.Tests;

[TestClass]
public partial class ExampleAccentColorExtractorTestClass : VisualUITestBase
{
    ...
    [UIThreadTestMethod]
    public void SimpleUIExamplePageTest(ExampleAccentColorExtractorTestPage page)
    {
    }

    // You can still do async work with a UIThreadTestMethod as well.
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleAccentColorExtractorTestPage page)
    {
