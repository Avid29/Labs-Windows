...
[ToolkitSample(id: nameof(NodeGraphTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class NodeGraphTemplatedSample : Page
{
    public NodeGraphTemplatedSample()
    {
