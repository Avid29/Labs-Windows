...
namespace NodeGraphExperiment.Samples;
...
[ToolkitSample(id: nameof(NodeGraphXbindBackedStyleCustomSample), "Backed templated control (restyled)", description: "A sample for showing how to create and use a templated control with a backed resource dictionary and a custom style.")]
public sealed partial class NodeGraphXbindBackedStyleCustomSample : Page
{
    public NodeGraphXbindBackedStyleCustomSample()
    {
