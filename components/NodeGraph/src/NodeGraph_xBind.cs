...
/// </summary>
public partial class NodeGraph_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="NodeGraph_xBind"/> class.
    /// </summary>
    public NodeGraph_xBind()
    {
        this.DefaultStyleKey = typeof(NodeGraph_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(NodeGraph_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((NodeGraph_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
