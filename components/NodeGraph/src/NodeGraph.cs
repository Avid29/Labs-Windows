...
/// You can choose to start here or from the <see cref="NodeGraph_ClassicBinding"/> or <see cref="NodeGraph_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class NodeGraph : Panel
{
    ...
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(NodeGraph), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is NodeGraph panel)
        {
