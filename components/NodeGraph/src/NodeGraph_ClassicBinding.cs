...
public partial class NodeGraph_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="NodeGraph_ClassicBinding"/> class.
    /// </summary>
    public NodeGraph_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(NodeGraph_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(NodeGraph_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(NodeGraph_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((NodeGraph_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
