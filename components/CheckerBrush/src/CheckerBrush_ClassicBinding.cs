...
public partial class CheckerBrush_ClassicBinding : Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="CheckerBrush_ClassicBinding"/> class.
    /// </summary>
    public CheckerBrush_ClassicBinding()
    {
        this.DefaultStyleKey = typeof(CheckerBrush_ClassicBinding);
    }
    ...
    public static readonly DependencyProperty ItemPaddingProperty = DependencyProperty.Register(
        nameof(ItemPadding),
        typeof(Thickness),
        typeof(CheckerBrush_ClassicBinding),
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(CheckerBrush_ClassicBinding),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((CheckerBrush_ClassicBinding)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
