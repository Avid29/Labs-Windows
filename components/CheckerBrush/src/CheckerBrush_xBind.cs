...
/// </summary>
public partial class CheckerBrush_xBind: Control
{
    /// <summary>
    /// Creates a new instance of the <see cref="CheckerBrush_xBind"/> class.
    /// </summary>
    public CheckerBrush_xBind()
    {
        this.DefaultStyleKey = typeof(CheckerBrush_xBind);
    ...
    public static readonly DependencyProperty MyPropertyProperty = DependencyProperty.Register(
        ...
        typeof(string),
        typeof(CheckerBrush_xBind),
        new PropertyMetadata(defaultValue: string.Empty, (d, e) => ((CheckerBrush_xBind)d).OnMyPropertyChanged((string)e.OldValue, (string)e.NewValue)));
