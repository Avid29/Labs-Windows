...
/// You can choose to start here or from the <see cref="CheckerBrush_ClassicBinding"/> or <see cref="CheckerBrush_xBind"/> example components. Remove unused components and rename as appropriate.
/// </summary>
public partial class CheckerBrush : Panel
{
    /// <summary>
    /// Identifies the <see cref="Orientation"/> property.
    /// </summary>
    public static readonly DependencyProperty OrientationProperty =
        DependencyProperty.Register(nameof(Orientation), typeof(Orientation), typeof(CheckerBrush), new PropertyMetadata(null, OnOrientationChanged));
    ...
    {
        if (dependencyObject is CheckerBrush panel)
        {
