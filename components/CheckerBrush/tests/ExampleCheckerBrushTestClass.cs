...
namespace CheckerBrushTests;

[TestClass]
public partial class ExampleCheckerBrushTestClass : VisualUITestBase
{
    // If you don't need access to UI objects directly or async code, use this pattern.
    [TestMethod]
    public void SimpleSynchronousExampleTest()
    {
        var assembly = typeof(CheckerBrush).Assembly;
        var type = assembly.GetType(typeof(CheckerBrush).FullName ?? string.Empty);

        Assert.IsNotNull(type, "Could not find CheckerBrush type.");
        Assert.AreEqual(typeof(CheckerBrush), type, "Type of CheckerBrush does not match expected type.");
    }
    ...
    {
        var component = new CheckerBrush();
    ...
    [UIThreadTestMethod]
    public void SimpleUIExamplePageTest(ExampleCheckerBrushTestPage page)
    {
        // You can use the Toolkit Visual Tree helpers here to find the component by type or name:
        var component = page.FindDescendant<CheckerBrush_ClassicBinding>();

        Assert.IsNotNull(component);

        var componentByName = page.FindDescendant("CheckerBrushControl");
    ...
    [UIThreadTestMethod]
    public async Task SimpleAsyncUIExamplePageTest(ExampleCheckerBrushTestPage page)
    {
    ...
    public async Task ComplexAsyncUIExampleTest()
    {
        await EnqueueAsync(() =>
        {
            var component = new CheckerBrush_ClassicBinding();
            Assert.IsNotNull(component);
        });
    }
