...
[ToolkitSample(id: nameof(CheckerBrushTemplatedSample), "Templated control", description: "A sample for showing how to create and use a templated control.")]
public sealed partial class CheckerBrushTemplatedSample : Page
{
    public CheckerBrushTemplatedSample()
    {
